...
import SkillsMarquee from '../portfolio/components/skills/SkillsMarquee';
    ...
    <div className="relative">
      ...
      >
        ...
        <div className="container mx-auto px-4 pt-32 pb-8 text-center z-10">
          ...
          >
            <div className="mb-8">
              <span className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary-400 to-blue-400 bg-clip-text text-transparent heading-glow">
                MEET THE CREATOR
              </span>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl mt-0" ref={whoRef}>
          <div className="relative">
            ...
            <motion.div
              ...
              viewport={{ once: true, margin: "-100px" }}
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-8 heading-glow section-title-gradient">Who I Am</h2>
      ...
      >
        <div className="container mx-auto px-4 mb-12">
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 heading-glow section-title-gradient">My Toolkit</h2>
            <div className="w-20 h-1 bg-primary neon-divider"></div>
      ...
      >
        <div className="container mx-auto px-4 max-w-3xl text-center">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 className="text-3xl sm:text-4xl font-bold mb-4 heading-glow section-title-gradient">Let's Connect</h2>
          ...
          >
            <a 
              ...
              download 
              className="bg-primary text-black font-medium rounded-full px-8 py-4 inline-flex items-center gap-2 group-hover:bg-primary/90 transition-all duration-300 cta-button"
            >
